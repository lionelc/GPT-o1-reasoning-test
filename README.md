...
While o1-preview/o1-mini can crack the easier apple thief puzzle correctly every time, it shows instability for the more difficult Zebra Puzzle. Moreover, when we swap a couple of feature names in the Zebra Puzzle (which doesn't change the nature or difficulty at all), o1-preview's correctness rate drops significantly.  
